                ...
                >
                    <div class="flex justify-between items-center h-full">
                        ...
                        >
                            ...
                            <button
                                class="smallDeviceMenuController hidden md:inline-block xl:hidden"
                            >
                                <iconify-icon
                            ...
                            >
                                ...
                                ></iconify-icon>
                                <span class="xl:inline-block hidden ml-3"
                                    >Search...
                                </span>
                            </button>
                        </div>
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="index.html">
                                                <div
                                                    class="flex space-x-2 items-start rtl:space-x-reverse"
                                                >
                                                    <iconify-icon
                                    ...
                                    <div class="rt-mega-menu">
                                        ...
                                        >
                                            <div>
                                                ...
                                                <a
                                                    href="forget-password-three.html"
                                                >
                                                    <div
                                                        class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse"
                                                    >
                        ...
                        >
                            ...
                            <div class="relative md:block hidden">
                                ...
                                >
                                    ...
                                    >
                                        <h3
                                            class="text-sm font-Inter font-medium text-slate-700 dark:text-white"
                                        >
                                            Messages
                                        </h3>
                                        <a
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="flex-none">
                                                    ...
                                                    >
                                                        <span
                                                            class="bg-secondary-500 w-[10px] h-[10px] rounded-full border border-white dark:border-slate-700 inline-block absolute right-0 top-0"
                                                        ></span>
                                                        <img
                                        ...
                                        >
                                            ...
                                            >
                                                <div class="flex-none">
                                                    ...
                                                    >
                                                        <span
                                                            class="bg-green-500 w-[10px] h-[10px] rounded-full border border-white dark:border-slate-700 inline-block absolute right-0 top-0"
                                                        ></span>
                                                        <img
                            ...
                            <div class="relative md:block hidden">
                                ...
                                >
                                    ...
                                    <div class="" role="none">
                                        ...
                                        >
                                            <div
                                                class="flex ltr:text-left rtl:text-right"
                                            >
                                                <div
                                                    class="flex-none ltr:mr-3 rtl:ml-3"
                                                >
                                                    <div
                                                        class="h-8 w-8 bg-white rounded-full"
                                                    >
                                                        <img
                                                            src="/assets/images/all-img/user.png"
                                                            alt="user"
