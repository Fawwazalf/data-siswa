          ...
          <div class="auth-box h-full flex flex-col justify-center">
            ...
            <form class="space-y-4" method="POST" action="{{ route('login') }}">
              ...
              <div class="fromGroup">
                ...
                <div class="relative ">
                  <input type="email" name="email" class="  form-control py-2" placeholder="Email" value="{{ old('email') }}" required>
                </div>
              </div>
              <div class="fromGroup       ">
            ...
            <div class="max-w-[242px] mx-auto mt-8 w-full">
              ...
              <ul class="flex">
                ...
                <li class="flex-1">
                  <a href={{ route('login.provider', ['provider' => 'google']) }} class="inline-flex h-10 w-10 bg-[#EA4335] text-white text-2xl flex-col items-center justify-center rounded-full">
